namespace NZWalks.API.Utilities
{
    ...
    {
        public static void SeedData(NZWalksDbContext context)
        {
            SeedDifficulties(context);
            SeedRegions(context);
        }

        private static void SeedDifficulties(NZWalksDbContext context)
        {
        ...
        private static void SeedRegions(NZWalksDbContext context)
        {
